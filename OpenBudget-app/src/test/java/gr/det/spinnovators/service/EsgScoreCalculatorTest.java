...
/**
 * Unit tests for the {@link EsgScoreCalculator} class.
 *
 * <p>This test suite verifies the calculation logic for ESG scores, ensuring
 * that budget entries are correctly categorized and weighted to produce
 * accurate environmental, social, and governance reports.</p>
 *
...
public class EsgScoreCalculatorTest {
  ...
  /**
   * Tests the full calculation of an ESG report from a hierarchical year structure.
   * Verifies that budget entries are mapped to the correct ESG categories and that
   * the overall score is calculated using the appropriate weights.
   *
   * <p>Logic verified:
   * <ul>
   * <li>Summing amounts per ESG category.</li>
   * <li>Calculating percentage scores based on total budget.</li>
   * <li>Applying weights (E:0.4, S:0.3, G:0.3) for the final score.</li>
   * </ul>
   * </p>
   */
  @Test
  ...
  /**
   * Tests the score comparison logic between two reports.
   * Verifies that the calculator correctly identifies the numerical difference
   * between a 'before' and an 'after' state.
   */
  @Test
